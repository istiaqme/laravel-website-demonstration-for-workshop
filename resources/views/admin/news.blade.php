...
@section('title', 'Admin | News | Ixony Engineering Limited') 
@section('content')
...
<div class="container">
    <div class="card mb-4 mt-5">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h2 class="font-weight-bold text-7 mt-2 mb-0">Add A New News</h2>

                    <form action="{{ url('ixony/news/create') }}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        @if(session('success'))
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <p class="text-primary">W: 700px, H: 400px - Format: webp</p>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                ...
                                <textarea maxlength="5000" data-msg-required="Required." rows="6" class="form-control text-3 h-auto py-2" name="details" id="details" required=""></textarea>
                            </div>
                        </div>
