...
@section('title', 'Admin | Brands | Ixony Engineering Limited') 
@section('content')
...
<div class="container">
    <div class="card mb-4 mt-5">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h2 class="font-weight-bold text-7 mt-2 mb-0">Add A New Brand</h2>

                    <form action="{{ url('ixony/brands/create') }}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        @if(session('success'))
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <p class="text-primary">W: 300px, H: 100px - Format: webp</p>
                                ...
                                @foreach ($list as $key => $listItem)
                                    <tr>
                                        ...
                                        <td>
                                            {{-- <div class="mb-2">
                                                <a 
                                                    href="{{ url('/ixony/brands/delete') }}/{{ $listItem->id }}" 
