...
@section('title', 'Admin | Services | Ixony Engineering Limited') 
@section('content')
...
<div class="container">
    <div class="card mb-4 mt-5">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h2 class="font-weight-bold text-7 mt-2 mb-0">Add A New Service</h2>

                    <form action="{{ url('ixony/services/create') }}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        @if(session('success'))
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <p class="text-primary">W: 500px, H: 350px - Format: webp</p>
                            ...
                            <tbody>
                                ...
                                @foreach ($list as $key => $listItem)
                                    <tr>
                                        ...
                                        <td>
                                            <a 
                                                href="{{ url('/ixony/services/with/brands/view/') }}/{{ $listItem->id }}" 
